...
public class Point implements Cloneable, Serializable {
	...
	/**
	 * A utilis� pour enchainer les op�rations sur la copie, contrairement � clone()
	 ...
	 * <p>
	 * retourne l'instance pour enchainer les op�rations
	 * 
	 ...
	 * retourne l'instance pour enchainer les op�rations
	 * 
	 * @param a le point contenant les valeur a copi�
	 * @return this
	 */
	...
	/**
	 * Fait la somme des points donn�s en param�tre et inscrit le resultat dans
	 * l'instance
	 * <p>
	 * retourne l'instance pour enchainer les op�rations
	 * 
	...
	/**
	 * Ajoute les valeurs donn�es en param�tre, aux attributs de l'instance
	...
	/**
	 * Ajoute les composantes du point donn� en param�tre, aux attributs de
	...
	/**
	 * Soustrait les valeurs donn�es en param�tre, aux attributs de l'instance
	 * composante par composante
	 * <p>
	 * retourne l'instance pour enchainer les op�rations
	 * 
	...
	/**
	 * Soustrait les composantes du point donn� en param�tre, aux attributs de
	 * l'instance composante par composante
	 * <p>
	 * retourne l'instance pour enchainer les op�rations
	 * 
	...
	/**
	 * Soustrait les composantes des point donn� en param�tre, aux attributs de
	 * l'instance composante par composante
	 * <p>
	 * retourne l'instance pour enchainer les op�rations
	 * 
	...
	/**
	 * Calcule le rep�re orthonorm� apr�s avoir subit des rotations autour de l'axe
	 ...
	 * z).
	 * 
	 * @return le rep�re orthonorm� calcul�
	 */
	...
	/**
	 * Calcule les coordonn�es du Point dans le nouveau rep�re orthonorm� fournit en
	 * param�tre. Un rep�re est un tableau de trois Point.
	 * <p>
	 * Sch�ma : 
	 * <p>
	 ...
	 * retourne l'instance pour enchainer les op�rations
	 * 
	 * @param system un rep�re orthonorm�
	 * @return this
	 */
	...
	/**
	 * Calcule les coordonn� du Point, apr�s avoir subit des rotations autour de
	 * l'axe x y et z. <br>Les coefficients des rotation provenant du param�tre (Point
	 * "Angle" dont chaque composante represente une rotation autour de l'axe x y
	 * z).
	 * <p>
	 * retourne l'instance pour enchainer les op�rations
	...
	/**
	 * Teste si le Point fait parti de la droite represent� par le segment
	 * 
	 * @param s
	 * @return le resultat du test
	 * 
	 ...
	 * &nbsp;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;|z = a.x*b.y - a.y*b.x
	 * <p>
	 * c = a /\ b avec a et b non colin�aire <br>
	 * | c est orthogonale � a et b <br>
	 ...
	 * <p>
	 * Si les point (e1, ..., en) forme une base orthogonale, on peut alors exprim�
	 * a tq :
	 * <p>
	 * a = k1*e1 + k2*e2 + ... + kn*en
	 * <p>
	 ...
	 * point en commun representant l'origine), on peut alors exprim� a tq :
	 * <p>
