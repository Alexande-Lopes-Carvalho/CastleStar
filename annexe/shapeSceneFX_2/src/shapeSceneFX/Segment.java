...
public class Segment implements Cloneable, Serializable {
	...
	/**
	 * Regarde si p appartient à la droite representer par this
	...
	/**
	 * Teste si les segments this et k sont sécants
	 * 
	 * @param k
	 * @return résultat du test
	 */
	...
	/**
	 * Teste si la droite this et le segment k sont sécants
	 * 
	 * @param k
	 * @return résultat du test
	 */
	...
	/**
	 * Teste si le segment this et la droite k sont sécants
	 * 
	 * @param k
	 * @return résultat du test
	 */
	...
	/**
	 * Teste si les droites this et k sont sécantes
	 * 
	 * @param k
	 * @return résultat du test
	 */
	...
	/**
	 * Indique de quel coté se trouve le point c par rapport au Segment this
